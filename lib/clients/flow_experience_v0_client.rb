...
# apidoc:0.11.29 http://www.apidoc.me/flow/experience/0.0.38/ruby_client
      ...
      module V0
        ...
        class Client
          ...
          module Constants
            ...
            USER_AGENT = 'apidoc:0.11.29 http://www.apidoc.me/flow/experience/0.0.38/ruby_client' unless defined?(Constants::USER_AGENT)
        ...
        module Models
          ...
          class Display
            ...
            def initialize(incoming={})
              ...
              @experience = (x = opts.delete(:experience); x.is_a?(::Io::Flow::Experience::V0::Models::ExperienceReference) ? x : ::Io::Flow::Experience::V0::Models::ExperienceReference.new(x))
            end
          ...
          class Experience
            ...
            def initialize(incoming={})
              ...
              @name = HttpClient::Preconditions.assert_class('name', opts.delete(:name), String)
              @subcatalog = (x = opts.delete(:subcatalog); x.is_a?(::Io::Flow::Catalog::V0::Models::SubcatalogReference) ? x : ::Io::Flow::Catalog::V0::Models::SubcatalogReference.new(x))
            end
